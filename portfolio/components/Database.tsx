...
const Database = () => {
  return (
    ...
    <div className={` target-section h-fit w-11/12 py-2 rounded-2xl`} >
        ...
        <p className={`${window.outerWidth<=300?"text-sm":"text-base"} mb-7 p-2 sm:p-4 text-blue-950 relative bottom-3 sm:bottom-6  sm:text-xl md:text-2xl lg:text-4xl font-extrabold bg-gradient-to-b rounded-md from-blue-500 to-white opacity-85`}>Database Tech</p>
